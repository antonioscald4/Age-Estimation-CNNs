...
checkpointer = ModelCheckpoint(
    filepath='classification_age_model_vgg_final_test_undersampling.h5'
    , monitor = "val_loss"
    , verbose=1
    , save_best_only=True
    , mode = 'auto'
...
age_model.save_weights('classification_age_model_vgg_final_test_weights_undersampling')
from keras.models import save_model
save_model(age_model,'./classification_age_model_vgg_final_test_folder_undersampling')
...
plt.show()
plt.savefig('VGG_Accuracy_v2.png')
plt.clf()
...
plt.legend(['train', 'validation'], loc='upper left')
plt.show()
plt.savefig('VGG_Age_Mae_v2.png')
plt.clf()
...
plt.legend(['train', 'validation'], loc='upper left')
plt.show()
plt.savefig('VGG_Variance_v2.png')
plt.clf()
...
plt.legend(['train', 'validation'], loc='upper left')
plt.show()
plt.savefig('VGG_AAR_metric_v2.png')
plt.clf()

np.savez(('history_vgg_final_undersampling.npz'), history=history.history)
